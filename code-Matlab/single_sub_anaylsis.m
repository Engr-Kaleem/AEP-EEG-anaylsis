...
str=[subject_id,'_',stimdur,'_',FREQ,'epoch_anti.set']
...
EEG_anti = pop_loadset([filedir,subject_id,'_',stimdur,'_',FREQ,'_epoch_anti.set']);
EEG_in = pop_loadset([filedir,subject_id,'_',stimdur,'_',FREQ,'_epoch_in.set']);
