...
subject_id = 'Sub_2';       % used to load from inside data folder
...
excel_out = fullfile(dataset_dir,'freq_analysis.xlsx')
...
freq_bands_names = {'15-20', '20-25', '25-30', '30-35', '35-40', '40-45', '45-50'};
...
%% Load dataset 
subject_data_dir = fullfile(dataset_dir);
