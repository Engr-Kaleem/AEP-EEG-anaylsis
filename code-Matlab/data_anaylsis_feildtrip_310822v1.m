...
% for i 1;nfiles
    filename=[filedir,'Sub_2_MLR_500_epoch_anti.s
    cfg = [];
...
%      define trails
    ...
    cfg.trialdef.eventvalue     ='AntiPhase' ; % the values of the stimulus trigger for the three conditions
...
%    artfct       = ft_databrowser(cfg, data_all)
    ...
    hold on
    plot(data_all.time{1},data_all.trial{1}(13,:))
    plot(data_all.time{1},data_all.trial{1}(14,:))
